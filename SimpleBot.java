...
public class SimpleBot {
        ...
        final Map<String, String> PATTERNS_FOR_ANALYSIS = new HashMap<String, String>() {
...

                {
                        ...
                        put("общежити*", "общежитие");
                        put("перв[уюая]\\s*.*волн[ау]*", "Приказы");
        ...
        final Map<String, String> ANSWERS_BY_PATTERNS = new HashMap<String, String>() {
                ...
                {
                        //приветствие
                        put("старт", "Здравствуйте, я чат-бот Политехник и я легко найду ответ на любой ваш вопрос) У меня вы можете узнать необходимую информацию о " +
                                "ходе приемной комиссии, необходимых условий поступления, самой актуальной информации об Университете и много другой занимательной информации) Спешите задать вопрос) ");
                        ...
                        put("общежитие", "Конечно, всем иногородним студентам предоставляются общежития, подробнее ");
                        put("документы", "Все необходимые документы представлены здесь http://pk.ulstu.ru/index.php?nav=rules2018");
                        put("направления", "В ульяновском техническом вы можете пройти обучения на таких факультетах, как Заочно-вечерний факультет\n" +
                                ...
                                "Узнайте больше об факультетах-введите название факультета по примеру: Заочно-вечерний(отправить) Машиностроительный(отправить)");
